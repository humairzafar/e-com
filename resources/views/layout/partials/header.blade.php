                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                ...
                                <div class="notification-actions" id="notification-actions">
                                    <div class="d-flex text-muted justify-content-center">
                                        Select <div id="select-content" class="text-body fw-semibold px-1" data-bs-target="#removeNotificationModal">0</div> Result <button type="button" class="btn btn-link link-danger p-0 ms-3" data-bs-toggle="modal">Remove</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            @php
                            auth()->user() ?'<h6 class="dropdown-header">Welcome {{ auth()->user()->name }}</h6>':'';
                            @endphp
                            ...
                            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                @csrf
                                <button type="submit" style="all: unset; cursor: pointer;" class="dropdown-item">
